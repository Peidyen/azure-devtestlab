...
function UpdateRMTemplates
{
    ...
    # Ensure that the cmdlets folder  exists.
    $destCmdletsFolder = Join-Path -Path $PSScriptRoot -ChildPath "..\..\Cmdlets\AzureRM.DevTestLab" -Resolve -ErrorAction "Stop"
...
function GenerateModuleManifest
{
    ...
    # Ensure that the cmdlets folder  exists.
    $srcCmdletsFolder = Join-Path -Path $PSScriptRoot -ChildPath "..\..\Cmdlets\AzureRM.DevTestLab" -Resolve -ErrorAction "Stop"

    # Ensure that the module script file exists.
    $srcModuleScriptFile = Join-Path -Path $PSScriptRoot -ChildPath "..\..\Cmdlets\AzureRM.DevTestLab\AzureRM.DevTestLab.psm1" -Resolve -ErrorAction "Stop"
    ...
    $destModuleManifestFilepath = $(Join-Path -Path $PSScriptRoot -ChildPath "..\..\Cmdlets\AzureRM.DevTestLab\AzureRM.DevTestLab.psd1")
...
function PublishModule
{
    ...
    $moduleManifestFile = Join-Path -Path $PSScriptRoot -ChildPath "..\..\Cmdlets\AzureRM.DevTestLab\AzureRM.DevTestLab.psd1" -Resolve -ErrorAction "Stop"
